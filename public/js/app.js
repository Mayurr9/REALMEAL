...
function initAdmin() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/admin/orders', {
    ...
    orders = res.data; // console.log("await")

    console.log(orders + "empty");
    markup = generateMarkup(orders); // console.log(markup + "markup")
...
if (adminAreaPath.includes('admin')) {
  Object(_admin__WEBPACK_IMPORTED_MODULE_2__["initAdmin"])(); // socket.emit('join', 'adminRoom')
}
